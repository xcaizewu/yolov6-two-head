...
#     parser.add_argument('--weights', type=str, default='/home/user/8T/ZY/code/zc/YOLOv6/runs/train/exp3/weights/best_ckpt.pt', help='weights path')
...
#                               input_names=['images'],
#                               output_names=['num_dets', 'det_boxes', 'det_scores', 'det_classes'] if args.end2end else ['outputs1', 'outputs2'],
...
if __name__ == '__main__':
    img = torch.zeros(2, 3, 640, 640).to('cuda:0')
    print(img)