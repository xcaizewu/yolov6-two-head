...
class Evaler:
    ...
    def predict_model(self, model, dataloader, task, mode):
        '''Model prediction
        ...
        for i, (imgs, targets, paths, shapes) in enumerate(pbar):
            # pre-process
            t1 = time_sync()
            # print('eval imgs shapes is:', imgs.shape)
