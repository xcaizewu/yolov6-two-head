...
# COCO默认的80类
CLASSES = ['proper', 'twhead', 'nomask', 'cleye', 'opeye', 'broadcast', 'head', 'mask', 'handpose', 'stand', 'incline', 'callphone', 'telephone', 'smokeperson']  # class names
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='/home/user/caizewu/code/project/zc/YOLOv6/runs/train/exp1/weights/best_ckpt.onnx', help='Path to ONNX model')
    parser.add_argument('--source', type=str, default='/home/user/caizewu/project/中车/中车数据/高铁项目/训练数据/data/images/test/01_000470.jpg', help='Path to input image')
    ...
    # Build model
    model = YOLOv6(args.model, args.imgsz)
